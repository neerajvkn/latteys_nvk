# Copyright (c) 2022, Neeraj VK and contributors
...
def get_data(conditions, filters):
	data = frappe.db.sql("""
		SELECT
			...
			po.status, po.supplier, po.supplier_name as supplier_name, 
			poi.item_code, poi.item_name as item_name, poi.description as description,
			...
			( 
				...
				AND cm.reference_name = po.name
				AND cm.reference_doctype = 'Purchase Order' ORDER BY cm.modified DESC LIMIT 1  ) as comment
		FROM
